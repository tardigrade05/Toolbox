...
def corner_radius_padding():
    with dpg.theme(tag = 'corner_padding'):
        with dpg.theme_component(dpg.mvAll):
            dpg.add_theme_style(dpg.mvStyleVar_FrameRounding,6 , category=dpg.mvThemeCat_Core)
            dpg.add_theme_style(dpg.mvStyleVar_FramePadding,6,4.5)
...
def img_stack():
    ...
    delete_small_w, delete_small_h, _, delete_small = dpg.load_image("toolbox/images/delete_small.png") 
    export_excel_w, export_excel_h, _, export_excel = dpg.load_image("toolbox/images/export_excel.png") 
    add_small_w, add_small_h, _, add_small = dpg.load_image("toolbox/images/add_small.png") 
    ...
    with dpg.texture_registry(show=False):
        ...
        dpg.add_static_texture(width=delete_small_w, height=delete_small_h, default_value=delete_small,tag = 'delete_small_img')
        dpg.add_static_texture(width=export_excel_w, height=export_excel_h, default_value=export_excel,tag = 'export_excel_img')
        dpg.add_static_texture(width=add_small_w, height=add_small_h, default_value=add_small,tag = 'add_small_img')